...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_nd_key)));
        //bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_show_only_opened_key)));
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        if ( !mBindingPreference ) {
            if (preference.getKey().equals(getString(R.string.pref_login_key))) {
                PadelSyncAdapter.syncImmediately(this);
            } else {
                // notify code that weather may be impacted
                getContentResolver().notifyChange(PadelContract.MatchesEntry.CONTENT_URI, null);
            }
        }

        if (preference.getKey().equals(getString(R.string.pref_password_key))){
